...
export default function PreviewDashboard() {
  ...
  // Aggregate feedback into a table: city -> category -> {good, irrelevant, inaccurate}
    ...
    <main className="min-h-screen pb-12">
      <header className="border-b border-[var(--border)] px-4 py-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div>
            <h1 className="font-serif text-xl font-bold">JustB Preview</h1>
      ...
      <div className="max-w-3xl mx-auto px-4 mt-6 space-y-8">
        {/* Feedback */}
        <section>
          <h2 className="font-serif text-lg font-semibold mb-3">Feedback</h2>
